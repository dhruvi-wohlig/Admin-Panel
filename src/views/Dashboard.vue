        ...
        <v-row>
            <v-col lg="7" cols="12">
                <v-alert dense text type="success">
                    Logged-in Successfully! Welcome to <strong>Candy Land</strong>
                </v-alert>
                <v-row>
...
<script>
    export default {
        ...
        data() {
            return {
                activityLog: [
                    {title: 'Total Products', amount: 42, icon: 'mdi-account', color: 'cyan lighten-3'},
                    {title: 'Total Customer', amount: 276, icon: 'mdi-account-group-outline', color: 'green darken-2'},
                    {title: 'Total Sale', amount: '₹50k+', icon: 'mdi-account-group-outline', color: 'blue-grey darken-1'},
                    {
